    ...
    public partial class mg1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 2, 10, 13, 21, 54, 883, DateTimeKind.Local).AddTicks(2674), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0m, 1 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "Date", "IsPaid", "PaymentDate", "Total", "UserId" },
                values: new object[] { 2, new DateTime(2020, 2, 10, 13, 21, 54, 887, DateTimeKind.Local).AddTicks(1997), false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0m, 2 });
